...
namespace Soenneker.Shippo.OpenApiClient.Models
{
    ...
    public partial class ShipmentExtraReturnServiceType : IComposedTypeWrapper, IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Shippo.OpenApiClient.Models.ShipmentExtraReturnServiceType"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Shippo.OpenApiClient.Models.ShipmentExtraReturnServiceType CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("")?.GetStringValue();
            var result = new global::Soenneker.Shippo.OpenApiClient.Models.ShipmentExtraReturnServiceType();
