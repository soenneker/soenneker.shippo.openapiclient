...
namespace Soenneker.Shippo.OpenApiClient.Models
{
    ...
    public partial class ServiceGroupCreateRequest : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public List<global::Soenneker.Shippo.OpenApiClient.Models.ServiceGroupAccountAndServiceLevel> ServiceLevels { get; set; }
#endif
        /// <summary>&quot;The type of the service group.- `LIVE_RATE`: Shippo will make a rating request and return real-time rates for the shipping group, only falling back to the specified flat rate amount if no rates match a service level in the service group.- `FLAT_RATE`: returns a shipping option with the specified flat rate amount.- `FREE_SHIPPING`: returns a shipping option with a price of $0 only if the total cost of items exceeds the amount defined by `free_shipping_threshold_min`&quot;</summary>
        public global::Soenneker.Shippo.OpenApiClient.Models.ServiceGroupTypeEnum? Type { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Shippo.OpenApiClient.Models.ServiceGroupCreateRequest"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Shippo.OpenApiClient.Models.ServiceGroupCreateRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Shippo.OpenApiClient.Models.ServiceGroupCreateRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Shippo.OpenApiClient.Models.ServiceGroupCreateRequest();
        }
        /// <summary>
